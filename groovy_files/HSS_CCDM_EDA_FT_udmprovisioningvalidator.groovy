pipelineJob('HSS_CCDM_EDA_FT_udmprovisioningvalidator') {
    properties {
    ...
    triggers {
        gerrit {
            ...
            configure { gerritTrigger ->
                ...
                new groovy.util.Node (filePath, 'pattern', 'Jenkinsfile.HSS_CCDM_EDA_FT_udmprovisioningvalidator/**')
    ...
    definition {
        cpsScm {
            scm {
                ...
                lightweight (false)
                scriptPath ('Jenkinsfile.HSS_CCDM_EDA_FT_udmprovisioningvalidator')
            }
        }
    }
}
